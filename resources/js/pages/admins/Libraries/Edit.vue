...
const props = defineProps<{ library: LibraryData }>();
...
const form = useForm({
    ...
    max_borrow_limit: props.library.max_borrow_limit ?? 10,
    _method: 'PUT',
});
...
const submit = () => form.post(route('admin.libraries.update', props.library.id));
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="space-y-6">
            ...
            <PageHeader :title="`Edit ${library.name}`" description="Update the details for this library.">
