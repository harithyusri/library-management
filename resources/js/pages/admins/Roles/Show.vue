        ...
        <div class="flex flex-1 flex-col gap-6 overflow-x-auto p-4">
            ...
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex gap-2">
                    ...
                    <Link v-if="can.manageRoles" :href="route('admin.roles.edit', role.id)">
                        <Button>
            ...
            <div class="grid gap-6 md:grid-cols-3">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle class="text-sm font-medium text-muted-foreground mt-4">
                            Total Permissions
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    ...
                    <CardContent>
                        <p class="text-lg font-medium text-foreground mb-4">
