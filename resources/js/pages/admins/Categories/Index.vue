    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="px-6 pt-2 pb-8 space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2 border-b border-slate-100">
                <div class="space-y-1">
                    <h1 class="text-3xl font-black tracking-tight text-slate-900">Book Categories <span class="text-indigo-600 text-6xl leading-none">.</span></h1>
                    <p class="text-slate-500 font-medium italic">Organize library assets by classifications and sections.</p>
                </div>

                <div class="flex items-center gap-3">
                    <Button v-if="$page.props.auth.can?.create_categories" @click="openAddDialog" class="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl px-6 h-11 font-bold shadow-lg shadow-indigo-100 dark:shadow-none flex items-center gap-2">
                        <Plus class="h-5 w-5" />
                        New Category
                    </Button>
                </div>
