...
const searchForm = reactive({
    ...
    library_id: props.filters?.library_id ?? 'all',
...
const search = () => {
    router.get(route('admin.staffs.index'), searchForm, {
        preserveScroll: true,
        preserveState: true,
    });
};
...
const deleteAdmin = () => {
    ...
    router.delete(route('admin.staffs.destroy', adminToDelete.value.id), {
        preserveScroll: true,
        onSuccess: () => {
            ...
            <Card>
                <CardContent class="p-6">
                    <div class="grid gap-4 md:grid-cols-6 items-end">
                        ...
                        <div>
                            <label class="mb-2 block text-sm font-medium text-foreground">Library</label>
                ...
                <CardContent class="p-0">
                    ...
                    <div v-if="staffs.data.length === 0" class="py-12 text-center">
                        ...
                        <div class="mt-4 flex justify-center gap-2">
                            ...
                            <Link v-if="can.createUsers" :href="route('admin.staffs.create')">
                                <Button>
                                ...
                                <TableRow v-for="admin in staffs.data" :key="admin.id">
                                    ...
                                    <TableCell class="text-right">
                                        <div class="flex justify-end gap-2">
                                            <Link :href="route('admin.staffs.show', admin.id)">
                                                <Button variant="ghost" size="sm">
                                                    View
                                                </Button>
                                            </Link>
                                            <Link v-if="can.editUsers" :href="route('admin.staffs.edit', admin.id)">
                                                <Button variant="ghost" size="sm">
