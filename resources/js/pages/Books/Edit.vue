...
const form = useForm({
    ...
    publication_year: props.book.publication_year ? String(props.book.publication_year) : '',
...
const coverImagePreview = ref<string | null>(props.book.cover_url ?? null);
...
const submitForm = () => {
    ...
    form.transform((data) => ({
        ...data,
        _method: 'PUT',
    })).post(route('books.update', props.book.id), { // 2. Then chain the .post()
        preserveScroll: true,
        forceFormData: true,
        onSuccess: () => {
