...
class MemberController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get users with roles of type 'member' and their member profiles
        ...
        return Inertia::render('admins/Members/Index', [
            'members' => $members,
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('admins/Members/Create');
    }
    ...
    public function show(Request $request, User $user)
    {
        ...
        return Inertia::render('admins/Members/Show', [
            'member' => $user,
    ...
    public function edit(Request $request, User $user)
    {
        ...
        return Inertia::render('admins/Members/Edit', [
            'member' => $user,
            'memberProfile' => $user->member,
        ]);
    }
